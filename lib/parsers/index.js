...
var forumToAtom = require('./forum-to-atom');
var forumCreation = require('./forum-to-atom-creation');
var topicCreation = require('./topic-to-atom-creation');
...
module.exports = {
  ...
  forumToAtom: function(jsonDoc, forumUuid){

    var result = forumToAtom(jsonDoc, forumUuid);
    return result;

  },
  forumCreation: function(jsonDoc){
    var result = forumCreation(jsonDoc);
    return result;
  },
  topicCreation: function(jsonDoc){
    var result = topicCreation(jsonDoc);
    return result;
  }
