...
IbmConnectionsForumsService.prototype.createForum = function updateForum(params, callback) {
  var self = this;

  var qsValidParameters = [];

  params.body=parsers.forumCreation(params.body);
  var requestOptions = _.merge(self.extractRequestParams(params), {
    method: 'POST',
    uri: '/forums/atom/forums',
    qs: _.pick(params, qsValidParameters),
...
IbmConnectionsForumsService.prototype.updateForum = function updateForum(params, callback) {
  ...
  var qsValidParameters = ['forumUuid'];

  params.body=parsers.forumToAtom(params.body,params.forumUuid);
  var requestOptions = _.merge(self.extractRequestParams(params), {
    method: 'PUT',
    uri: '/forums/atom/forum',
    qs: _.pick(params, qsValidParameters),
...
IbmConnectionsForumsService.prototype.createTopic = function updateForum(params, callback) {
  var self = this;

  var qsValidParameters = ['forumUuid'];

  params.body=parsers.topicCreation(params.body);
  var requestOptions = _.merge(self.extractRequestParams(params), {
    method: 'POST',
    uri: '/forums/atom/topics',
    qs: _.pick(params, qsValidParameters),
  ...
  self.makeRequest(requestOptions, function (err, response, body) {
    ...
    parsers.topic(body, function (err, forum) {
      if (err) {
        return callback(err);
      }
      return callback(null, forum);
...
IbmConnectionsForumsService.prototype.deleteTopic = function deleteForum(params, callback) {
  var self = this;
...
IbmConnectionsForumsService.prototype.deleteReply = function deleteForum(params, callback) {
  var self = this;
...
IbmConnectionsForumsService.prototype.getMembers = function getReply(params, callback) {
  var self = this;
  ...
  self.makeRequest(requestOptions, function (err, response, body) {
    ...
    parsers.members(body, function (err, reply) {
      if (err) {
        return callback(err);
      }
      return callback(null, reply);
...
IbmConnectionsForumsService.prototype.getMember = function getReply(params, callback) {
  var self = this;
  ...
  self.makeRequest(requestOptions, function (err, response, body) {
    ...
    parsers.member(body, function (err, reply) {
      if (err) {
        return callback(err);
      }
      return callback(null, reply);
...
IbmConnectionsForumsService.prototype.deleteMember = function deleteForum(params, callback) {
  var self = this;
